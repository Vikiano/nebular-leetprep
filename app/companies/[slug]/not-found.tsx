  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20 text-center">
      <div className="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-900 px-4 py-1.5 text-xs text-slate-400 mb-8">
        Company path not in library
      </div>
      <h1 className="text-3xl font-bold mb-4">We do not have that company yet</h1>
      <p className="text-slate-400 mb-8">
        Current roster: Amazon, Google, Meta, Apple, Netflix, Microsoft, Stripe, OpenAI, Airbnb, Uber.
        More companies ship weekly.
      </p>
